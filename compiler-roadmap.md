...
| C 后 ID/arena 专项 | 约 30% | query dep-node arena 与 loader source handle 已完成；session node store 已接入 parser/origin 与 definition lookup，semantic side table、module/item/executable/work-product identity 尚未迁移。 |
