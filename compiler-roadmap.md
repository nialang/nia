...
| C 后 ID/arena 专项 | 约 52% | ID-0 query dep-node arena 与 ID-1 source/syntax identity 已完成；ID-2 已删除 compiler full-module-node query/shared-ref 双轨，下一步建立 stable module key/allocator 并共享 graph snapshot，再进入 item/executable/work-product identity。 |
