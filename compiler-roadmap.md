...
| C query value/storage | 约 45% | cache-owned `get/try_get` 与无 `Value: Clone` 已建立；loader、compiler resolution/type/normalization/layout/body 及 const/ABI/static/flow 产品已共享到 aggregate，其余 owned `query/query_many`、function/backend IR 产品与 registry 尚未完成。 |
