...
| C query value/storage | 约 35% | cache-owned `get/try_get` 与无 `Value: Clone` 已建立；loader、compiler resolution/type-resolution/lowering/normalization 及 const/ABI/static/flow 产品已共享到 aggregate，其余 owned `query/query_many`、layout/body 产品与 registry 尚未完成。 |
