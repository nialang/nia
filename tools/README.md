...
The repository maintenance interface is the `nia-maintain` Rust binary in this
directory. It is a normal workspace member: the root `Cargo.lock`, rustfmt,
...
Fixtures belong in `tools/fixtures/`, integration contracts in
`tools/nia-maintain/tests/`, and implementation tests beside their owning Rust
