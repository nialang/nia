...
#[test]
fn malformed_attribute_header_recovers_before_the_attributed_item() {
    let (module, errors) = parse_module("@[broken.]\nfn retained() () {}\nfn later() () {}");
    assert_eq!(
        errors
            .iter()
...
#[test]
fn unterminated_attribute_header_recovers_at_the_next_item() {
    let (module, errors) = parse_module("@[broken.\nfn retained() () {}\nfn later() () {}");
    assert_eq!(
        errors
            .iter()
