...
pub use pipeline::{
    ...
    check_freestanding_executable_with_options, check_program, check_program_with_map,
    check_program_with_map_and_options, check_program_with_map_options_and_timings,
