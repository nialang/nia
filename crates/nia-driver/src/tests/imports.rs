...
#[test]
fn reports_local_value_used_as_type() {
    let root = temp_dir("reports_local_value_used_as_type");
    let source = r#"const answer: i32 = 42;
...
"#;
    ...
    assert!(
        ...
        "missing value declaration evidence: {:?}",
        diagnostic.diagnostic
    );
}
