...
pub(in crate::query) use self::body_executable::{
    ExecutableFactLayoutCacheEntry, ExecutableValueRefEdges, provide_executable_function_body,
...
pub(super) struct CompilerQueryProviders {
    ...
    pub(super) const_enum_values:
        fn(&QueryDb<CompilerContext>, ModuleId) -> QueryResult<nia_const_check::ConstEnumValues>,
