...
provider boundary with `RESOLVE_BENEATH`; mutation and metadata calls retain
their host `*at` semantics until a safe parent-resolution design exists. Scalar lowering uses operation-scoped
