...
boundaries, and their top-level recovery now emit grammar nodes in production; the
next migration stage covers struct/union/enum/trait headers and nested recovery.
