...
Unterminated struct and union bodies now stop at a following top-level item
instead of treating a later function as a member and consuming its body, with
parser and driver coverage.
