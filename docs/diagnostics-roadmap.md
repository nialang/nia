...
second parser model. Attributes and top-level item boundaries now emit grammar
nodes in production; the next migration stage covers declaration headers and
nested recovery.
